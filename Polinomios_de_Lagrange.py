...
class linreg (polinomios):
    ...
    def __str__(self):
        expresion = ["Y=", self.alpha, "+", self.beta_MCO, "X"]
    ...
    def regplot(self):
        ...
        x_values = [n for n in range(-10,10)]
        y_values = [ ((self.beta_MCO * x)+self.alpha) for x in x_values]
        plt.plot(x_values, y_values, label = self.__str__())
    
    # def NR_reg(self):
        
            
datos = [(1,2),(2,1),(3,4), (4,8), (5,10)]     
a = linreg(datos)
